...
const consultoria = [
    {   img : AsesoriaInmobiliaria, 
        ...
        informacion : `Nuestro servicio de Asesoría Inmobiliaria te ayuda en los siguientes casos:`,
        detalleUno : `-VENTA Y/O ALQUILER de Local Comercial o Industrial (Si tienes una propiedad).`,
        detalleDos : `-COMPRA Y/O ALQUILER de Local Comercial o Industrial (Si desea adquirir o alquilar una propiedad).`,
    },
    {   img : ConsultoriaTradicional, 
        casos : 'Consultoria Tradicional',
        informacion : `Nuestro servicio de Consultoría Tradicional abarca un tema en específico donde el cliente quiere que se trabaje. Los temas mas solicitados son:`,
        detalleUno : `-Revisión de procesos para reducir costos.`,
        detalleDos : `-Mejorar el manejo de las finanzas de la empresa.`,
        detalleTres : `Como obtener un préstamo financiero.`,
    },
    ...
    {   img : ConsultoriaAdministrativa, 
        ...
        detalleUno : `El servicio consiste en tener un administrador para ordenar las finanzas y proyectar los costos. Con este servicio podrás saber la situación real de tu empresa y tener proyecciones para crecer. Te ofrecemos asesoría constante y seguimiento a tus ingresos y gastos de manera semanal, realizando 2 visitas al mes para ver de manera presencial el crecimiento de tu negocio.`,
    },
    {   img : Factoring, 
        casos : 'Factoring',
        informacion: `Nuestro Servicio de Factoring te ofrece liquidez en 48 horas.`,
        detalleUno : `Contamos con Factoring Nacional para las facturas entre empresas dentro del pais.`,
        detalleDos : `Y Factoring para Comercio Internacional para las Importaciones y Exportaciones.`,
    },
    {   img : AsesoriaLegal, 
        casos : 'Asesoria Legal',
        informacion: `Nuestro servicio de Asesoría legal te ayuda en:`,
        detalleUno : `-Negociacion de deudas ante Entidades Financieras, SAT, SUNAT y otros`,
        detalleDos : `-Evitar Remates Judiciales.`,
        detalleTres : `-Problemas Contractuales.`,
        detalleCuatro : `-Problemas Hipotecarios.`,
        detalleCinco : `-Recuperación de cartera morosa.`,
        detalleSeis: `-Registro de Marca y nombre comercial.`,
        detalleSiete: `-Patentes.`,
    },
    {   img : AsesoriaParaObtenerFinanciamientos, 
        ...
        detalleUno : `-Leasing (vehicular, Maquinaria y Equipos).`,
        detalleDos : `-Compra de local comercial o industrial.`,
        detalleTres : `-Compra de Terreno comercial o industrial.`,
        detalleCuatro : `-Capital de Trabajo.`,
    },
];
